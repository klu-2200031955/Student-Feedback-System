        ...
        <div class="content"> 
          ...
          <div class="table-container">
           <table>
            ...
            <tbody>
            	<c:choose>
            		<c:when test="${empty facultyrequestlist}">
            			<tr>
            		...
            		<c:otherwise>
            			...
            			<c:forEach items="${facultyrequestlist}" var="facultyrequest">
            				<tr>
            					<td>${counter}</td>
            	 				<td data-label="ID"><c:out value="${facultyrequest.id}"/></td>
                                <td data-label="Name"><c:out value="${facultyrequest.name}"/></td>
                                <td data-label="Date of Birth"><c:out value="${facultyrequest.dob}"/></td>
                                <td data-label="Gender"><c:out value="${facultyrequest.gender}"/></td>
                                <td data-label="Department"><c:out value="${facultyrequest.department}"/></td>
                                <td data-label="Contact"><c:out value="${facultyrequest.contact}"/></td>
                                <td class="action-icons">
				                    <form action="acceptFacultyRequest" method="post" style="display:inline;">
									    <input type="hidden" name="id" value="${facultyrequest.id}" />
									    <button type="submit" style="background:none; border:none; color: green; cursor: pointer;">
									        <i class="fas fa-check"></i>
									    </button>
									</form>
								    <form action="rejectFacultyRequest" method="post">
								        <input type="hidden" name="id" value="${facultyrequest.id}"/>
