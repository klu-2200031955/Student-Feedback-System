       ...
       <div class="main-container-content-box">
        <div class="content"> 
          <div class="content-header">
            <h2>Former Faculty Records</h2>
            <div class="button-container">
              <a href="adminfacultyrequest"><button class="edit-button">Request Access Records</button></a>
              <a href="adminfaculty"><button class="edit-button">Current Faculty Records</button></a>
            </div>
          </div>
          <div class="table-container">
           <table>
            ...
            <tbody>
            	<c:choose>
            		<c:when test="${empty facultyreject}">
            			<tr>
            		...
            		<c:otherwise>
            			...
            			<c:forEach items="${facultyreject}" var="facultyreject">
            				<tr>
            					<td>${counter}</td>
            	 				<td data-label="ID"><c:out value="${facultyreject.id}"/></td>
								<td data-label="Name"><c:out value="${facultyreject.name}"/></td>
								<td data-label="Date of Birth"><c:out value="${facultyreject.dob}"/></td>
								<td data-label="Gender"><c:out value="${facultyreject.gender}"/></td>
								<td data-label="Department"><c:out value="${facultyreject.department}"/></td>
								<td data-label="Contact"><c:out value="${facultyreject.contact}"/></td>

                                <td class="action-icons">
								    <form action="restorefaculty" method="post">
								        <input type="hidden" name="id" value="${facultyreject.id}"/>
