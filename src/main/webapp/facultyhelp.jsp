...
<html>
<head>
    <title>FeedCraft Faculty History</title>
...
<body>
    ...
    <div class="main-container-content-box">
        <div class="history-content">
            ...
            <div class="record">
                <img alt="Form Icon" height="40" src="./images/Form.png" width="40"/>
                <div class="details-head">
                    <p>CRT Application Form</p>
                </div>
                <div class="details-body">
                    <p>by - Director CRT<br/>expires by 07-10-2024</p>
                </div>
                <div class="status">
